...
class AdjoinTests {
  ...
  def testIandL: Unit = {
    ...
    typed[R](adjoin(1 :: ("foo" :: sym"a" :: HNil) :: HNil))
  }
  ...
  def testLandI: Unit = {
    ...
    typed[R](adjoin((1 :: "foo" :: HNil) :: sym"a" :: HNil))
  }
  ...
  def testLandL: Unit = {
    ...
    typed[R](adjoin((1 :: "foo" :: HNil) :: (sym"a" :: 'z' :: HNil) :: HNil))
  }
  ...
  def testCorC: Unit = {
    ...
    typed[R](adjoin(Inl(Inl(1))))
    typed[R](adjoin(Inr(Inl(Inl(sym"x")))))
  }
  ...
  def testHListSyntax: Unit = {
    ...
    typed[R]((1 :: "foo" :: (sym"a" :: HNil) :: HNil).adjoined)
  }
